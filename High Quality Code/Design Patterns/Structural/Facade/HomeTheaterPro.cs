namespace FacadePattern
{
    ...
    public class HomeTheaterPro
    {
        ...
        {
            this.db.Add(
                new MediaEntity { Title = "Stardust", FileExtention = "avi", Duration = 160, Content = new byte[200] });
            ...
            this.db.Add(
                new MediaEntity { Title = "Red", FileExtention = "mp4", Duration = 160, Content = new byte[200] });
        }
